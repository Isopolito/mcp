...
// Tool schemas
const BrainstormSchema = zod_1.z.object({
    problem_description: zod_1.z.string().describe("Detailed description of the technical challenge or problem"),
    context: zod_1.z.string().optional().describe("Additional context about your codebase, constraints, or environment"),
    brainstorm_type: zod_1.z.enum(["architecture", "debugging", "optimization", "design_patterns", "general"]).describe("Type of brainstorming session"),
    include_code_analysis: zod_1.z.boolean().optional().describe("Whether to include analysis of current codebase"),
});
const AnalysisSchema = zod_1.z.object({
    ...
    analysis_type: zod_1.z.enum(["security", "performance", "maintainability", "best_practices", "refactoring"]).describe("Type of analysis to perform"),
    specific_concerns: zod_1.z.string().optional().describe("Specific areas or concerns to focus on"),
});
const PlanningSchema = zod_1.z.object({
    project_description: zod_1.z.string().describe("Description of the project or feature to plan"),
    planning_focus: zod_1.z.enum(["implementation_plan", "architecture_review", "risk_assessment", "alternative_approaches"]).describe("Focus of the planning session"),
    constraints: zod_1.z.string().optional().describe("Technical or business constraints to consider"),
    goals: zod_1.z.string().optional().describe("Specific goals or success criteria"),
});
// Helper function to execute Claude Code
async function executeClaudeCode(prompt, timeoutMs = 280000) {
    return new Promise((resolve, reject) => {
        const childProcess = (0, child_process_1.spawn)("claude", ["--print"], {
    ...
    try {
        switch (name) {
            ...
            case "get_claude_code_analysis": {
                ...
                let prompt = `You are a member of my elite software engineering team. Please perform a ${analysis_type} analysis of: ${file_or_directory_path}\n\n`;
